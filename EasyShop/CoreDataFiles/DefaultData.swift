...
// "\(Text(NSLocalizedString("", comment: "")))Bakery"
//var shopsList = [
...
var shopsList = [
    ...
    Shops(id: 1003, name: "Para Picar", position: 2, item: [
    ...
    Shops(id: 1004, name: "Bebidas", position: 3, item: [
    ...
    Shops(id: 1006, name: "Resto Super", position: 5, item: [
